...
val tertiaryLight_Default = Color(0xFF3F51B5)
...
val onSurfaceLight_Orange = Color(0xFF1B1B1D)
...
val backgroundDark_Orange = Color(0xFF252020) // Black Background
val onBackgroundDark_Orange = Color(0xFFFFFFFF) // White Text
val surfaceDark_Orange = Color(0xFF252020) // Slightly Elevated Black
...
val tertiaryLight_Purple = Color(0xFFC56ECE) // Light Purple
...
val onPrimaryDark_Purple = Color(0xFFFFFFFF) // Deep Purple
...
val onPrimaryDark_Yellow = Color(0xFFFFFFFF) // Dark Brown
...
val surfaceDark_Yellow = Color(0xFF1B1B1D) // Matches background
